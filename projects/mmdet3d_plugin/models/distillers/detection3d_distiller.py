...
class DetectionDistiller(Base3DDetector):
    ...
    def forward_train(self, 
        ...
        for i, item_loc in enumerate(self.distill_cfg):
            ...
            # student_feat = self.adaptation_layers[i](student_feat)
            student_feat = self.adaptation(i, student_feat)
            # student_feat = self.adaptation_layers[i](student_feat.float()).half()
    ...
    @auto_fp16(apply_to=('feature'))
    def adaptation(self, i, feature):
        return self.adaptation_layers[i](feature)
