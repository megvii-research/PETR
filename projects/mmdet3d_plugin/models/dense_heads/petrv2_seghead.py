...
class PETRv2SegHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is PETRv2SegHead):
        ...
        super(PETRv2SegHead, self).__init__(num_classes, in_channels, init_cfg = init_cfg)
    ...
    def _init_layers(self):
        ...
        lane_branch.append(Linear(self.embed_dims, 64*3))
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is PETRv2SegHead:
            convert_dict = {
    ...
    def _get_target_single(self,
        ...
        if self.code_weights[0] > 1:
            assign_result = self.assigner.assign(bbox_pred, cls_score, gt_bboxes,
                                                    gt_labels, gt_bboxes_ignore, self.code_weights, True)
        else:
            assign_result = self.assigner.assign(bbox_pred, cls_score, gt_bboxes,
    ...
    def loss_single(self,
        ...
        return loss_cls, loss_bbox, loss_dri, loss_lan, loss_veh
    ...
    def loss(self,
        ...
        losses_cls, losses_bbox, losses_dri, losses_lan, losses_veh = multi_apply(
        ...
        num_dec_layer = 0
        for loss_cls_i, loss_bbox_i, loss_dri_i, loss_lan_i, loss_veh_i in zip(losses_cls[:-1], losses_bbox[:-1], losses_dri[:-1], losses_lan[:-1], losses_veh[:-1]):
