...
train_pipeline = [
    ...
    dict(type='Collect3D', keys=['gt_bboxes_3d', 'gt_labels_3d', 'img','maps'],
            meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img', 'intrinsics', 'extrinsics', 'bda',
                'pad_shape', 'scale_factor', 'flip', 'box_mode_3d', 'box_type_3d', 'lidar2img_lane',
...
# [0.8065914511680603, 0.38847818970680237, 0.4111063778400421]
# {'result': array([0.80659145, 0.38847819, 0.41110638])}
