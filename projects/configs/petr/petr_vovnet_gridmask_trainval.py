...
data = dict(
    ...
    test=dict(ann_file=data_root + 'nuscenes_infos_test.pkl', pipeline=test_pipeline, classes=class_names, modality=input_modality)
    )
...
# car     0.837   0.287   0.123   0.037   0.380   0.218
# truck   0.803   0.363   0.135   0.038   0.273   0.199
# bus     0.812   0.370   0.140   0.040   0.547   0.193
# trailer 0.766   0.430   0.141   0.046   0.161   0.160
# construction_vehicle    0.741   0.487   0.230   0.102   0.152   0.340
# pedestrian      0.788   0.402   0.220   0.211   0.260   0.161
# motorcycle      0.797   0.367   0.171   0.114   0.443   0.288
# bicycle 0.847   0.314   0.181   0.111   0.167   0.012
# traffic_cone    0.869   0.268   0.183   nan     nan     nan
# barrier 0.857   0.311   0.120   0.054   nan     nan
