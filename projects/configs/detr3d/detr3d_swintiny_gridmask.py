...
data = dict(
    ...
    test=dict(pipeline=test_pipeline, ann_file=data_root + 'nuscenes_infos_test.pkl',classes=class_names, modality=input_modality),
    )
...
# resume_from='work_dirs/detr3d_swintiny_gridmasktrainval/epoch_16.pth'
